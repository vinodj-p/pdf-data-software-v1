package com.aarte.doczy.textractprocessor.bean;

import java.io.Serializable;

public class TableRecordBean implements Serializable, Comparable<TableRecordBean>{
	...
	public String toString() {
		return "TableRecordBean [columnIndex=" + columnIndex + ", rowIndex=" + rowIndex + ", rowSpan=" + rowSpan
				+ ", columnSpan=" + columnSpan + ", pageNo=" + pageNo + ", columnHeader=" + columnHeader
				+ ", columnValue=" + columnValue + ", tableId=" + tableId + "]";
	}
	@Override
	public int compareTo(TableRecordBean tableRecordBean) {
		if (rowIndex == tableRecordBean.rowIndex)
			return 0;
		else if (rowIndex > tableRecordBean.rowIndex)
			return 1;
		else
			return -1;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TableRecordBean other = (TableRecordBean) obj;
